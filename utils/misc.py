...
def get_args():
    ...
    parser.add_argument("--agent_algo", type=str, default='maddpg', help="agent algorithm",
                        choices=['qmix', 'maddpg'])
    parser.add_argument("--model_type", type=str, default='mlp', help="neural network model",
                        choices=['mlp', 'lstm', 'lstm_communicate'])
    parser.add_argument("--param_sharing", type=str, default='individual', 
                        help="individual: no parameter sharing, team: parameter sharing among team members",
